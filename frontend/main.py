...
st.set_page_config(page_title='Urban Sematic Segmentation',page_icon="cityscape", layout = 'wide', initial_sidebar_state = 'auto')
...
image = st.sidebar.file_uploader("Chose an image file to upload",type= ['png', 'jpg','jpeg','WebP','bmp','tiff'] )
res = None
